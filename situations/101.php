    ...
    <div class="container" style="margin: 10px auto">
        <div class="shadow p-3 mb-5 bg-white rounded" style="padding:2.5rem!important">
            ...
            <section class="col" style="margin-top:50px">
                ...
                <hr />
                <div style="display: flex;margin:8px 0">
                    <img height="48" width="48" style="margin-right:10px;height:48px;width:48px" class="rounded-circle" src="/CKTU/images/p10.jpg">
                    <div style="flex-direction: column">
                        <h5>跳舞機</h5>
                        <div style="display:flex;flex-direction:row">
                            <div style="height:10px;width:10px;background:url(data:image/png;base64,) no-repeat left;"></div>
                        ...
                        <div>
                            我在一開始人物畫像和介紹哪裡不管點哪裡都沒用耶，之後要怎麼辦呢？
                        </div>
                    </div>
                </div>
                <hr />
                ...
                <hr />
                <div style="display: flex;margin:8px 0">
                    <img height="48" width="48" style="margin-right:10px;height:48px;width:48px" class="rounded-circle" src="/CKTU/images/p11.jpg">
                    <div style="flex-direction: column">
                        <h5>Leung Richard</h5>
                        <div style="display:flex;flex-direction:row">
                            <div style="height:10px;width:10px;background:url(data:image/png;base64,) no-repeat left;"></div>
                ...
                <hr />
                <div style="display: flex;margin:8px 0">
                    <img height="48" width="48" style="margin-right:10px;height:48px;width:48px" class="rounded-circle" src="/CKTU/images/p12.jpg">
                    <div style="flex-direction: column">
                        <h5>like Kinda</h5>
                        <div style="display:flex;flex-direction:row">
                            <div style="height:10px;width:10px;background:url(data:image/png;base64,) no-repeat left;"></div>
