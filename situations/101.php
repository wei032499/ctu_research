                            ...
                            <div style="margin: 5px auto 5px 25px ">
                                ...
                                <div style="display:flex;flex-direction:row">
                                    ...
                                    <div style="height: 10px;width:10px;background:url(data:image/png;base64,) no-repeat left;">
                                        <div style="height:10px;width:9.0px;background:url(data:image/png;base64,) no-repeat left;">
                                        </div>
                                    </div>
                                    <div style="height: 10px;width:10px;background:url(data:image/png;base64,) no-repeat left;">
                                    </div>
            ...
            <section class="col" style="margin-top:50px">
                <div style="display: flex;margin:8px 0">
                    ...
                    <div style="flex-direction: column">
                        ...
                        <div>
                            從去年8月都到今天了，中華電信Wifi連線還是時常lag卡頓！煩不勝煩！金招牌還130天，最多領完就退坑，簡單的數據消磨遊戲能讓玩家體驗如此差還真有你們的！
                        </div>
                    </div>
                </div>
                <hr />
                ...
                <div style="display: flex;margin:8px 0">
                    ...
                    <div style="flex-direction: column">
                        ...
                        <div>
                            可以看出遊戲製作的用心 玩法也不斷嘗試突破 20.01.19更新...遊戲lag的誇張 本來以為官方會努力處理問題 但快三個月了 只有越來越嚴重 漸漸的不太想玩了....
                        </div>
                    </div>
                </div>
                <hr />
                ...
                <div style="display: flex;margin:8px 0">
                    ...
                    <div style="flex-direction: column">
                        ...
                        <div>
                            卡牌幻境一直在回朔，回朔後卡片降等可大地卷沒回來，這樣要我玩個毛？
                        </div>
                    </div>
                </div>
                <hr />
