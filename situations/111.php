            ...
            <section class="col" style="margin-top:50px">
                ...
                <div style="display: flex;margin:8px 0">
                    ...
                    <div style="flex-direction: column">
                        ...
                        <div>
                            操作不太方便，有時候想移動物體結果變成了移動鏡頭。另外，不知為何莫名其妙丟失了進度要重頭開始。中文的錯字有些多，有部分翻譯不太能理解。
                        </div>
                    </div>
                </div>
                <hr />
                <div style="display: flex;margin:8px 0">
                    <img height="48" width="48" style="margin-right:10px;height:48px;width:48px" class="rounded-circle" src="/CKTU/images/p1.jpg">
                    <div style="flex-direction: column">
                        <h5>龔美秀</h5>
                        <div style="display:flex;flex-direction:row">
                            <div style="height:10px;width:10px;background:url(data:image/png;base64,) no-repeat left;"></div>
